// QualiHUB — boot, navegação e seletor de contrato (carregado por ÚLTIMO)
  ...
  function irPara(tab) {
    ...
    ({ dashboard: renderDashboard, ocorrencias: renderOcorrencias, pac: renderPac, temperatura: renderTemperatura, documentos: renderDocumentos, visitas: renderVisitas, cadastro: renderCadastro, empresa: renderEmpresa, clientes: renderClientes }[tab] || renderDashboard)();
  }
